...
$global:_ompExecutable = 'C:/Users/ocalvo/AppData/Local/Programs/oh-my-posh/bin/oh-my-posh.exe'
...
New-Module -Name "oh-my-posh-core" -ScriptBlock {
    ...
    if ('C:\Users\ocalvo\Documents\PowerShell\PoshThemes\markbull.omp.custom.yaml' -and (Test-Path -LiteralPath 'C:\Users\ocalvo\Documents\PowerShell\PoshThemes\markbull.omp.custom.yaml')) {
        $env:POSH_THEME = (Resolve-Path -Path 'C:\Users\ocalvo\Documents\PowerShell\PoshThemes\markbull.omp.custom.yaml').ProviderPath
    }
